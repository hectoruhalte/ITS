...
package Q_TRAMO is
   ...
   C_NUMERO_MAXIMO_CONEXIONES : constant Natural := 8;
   ...
   function F_OBTENER_LISTA_CRUCES (V_TRAMO_ACTUAL : in T_TRAMO;
                                    ...
                                    V_CARRIL_SIGUIENTE : in Natural) return Q_CONEXION.Q_LISTA_CRUCES.T_LISTA;
...
private
   ...
   type T_TRAMO is record
      ...
      R_ID : Natural range 0 .. C_NUMERO_MAXIMO_TRAMOS := 1;
      ...
      -- Registro para indicar el sentido de circulacion dependiendo de si el tramo se circula de origen a destino o de destino a origen.
      -- En el caso de tramos de un solo sentido, por defecto el sentido sera 1.
