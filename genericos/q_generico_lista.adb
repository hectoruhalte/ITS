...
package body Q_GENERICO_LISTA is
   ...
   procedure Unchecked_Free is new Ada.Unchecked_Deallocation (Object => T_CELDA,
                                                               Name   => T_PUNTERO_A_CELDA);

   pragma Controlled (T_PUNTERO_A_CELDA);
   ...
   ----------------------------------------------
   procedure P_FREE (V_LISTA : in out T_LISTA) is
   
      V_PUNTERO, V_PUNTERO_AUX : T_PUNTERO_A_CELDA := V_LISTA.R_CELDA_INICIAL;
      
   begin
      
      loop
         
         exit when V_PUNTERO_AUX = null;
         
         V_PUNTERO_AUX := V_PUNTERO.R_PUNTERO_A_CELDA;
         V_PUNTERO.R_PUNTERO_A_CELDA := null;
         V_PUNTERO := V_PUNTERO_AUX;
         
      end loop;
      
      V_LISTA.R_CELDA_INICIAL := C_PUNTERO_A_CELDA_INICIAL;
